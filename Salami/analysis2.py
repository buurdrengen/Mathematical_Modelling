...
# #compare_image(image = entire_im, day = 1 , title = "Day 1 - True Classification")
...
# entire_im2 = construct_entire_im(np.shape(multiIm[:,:,0]),index_fat2,index_meat2,index_background)

# #Chekc the result
# compute_errorrate(true_fat_index, true_meat_index, index_fat2, index_meat2)
# compare_image(image = entire_im2, day = 1 , title = "Day 1 - Classification by means of all spectral bands")
