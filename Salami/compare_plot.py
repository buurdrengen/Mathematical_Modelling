...
def compare_train(image1, image2 = np.array([0]), image3 = np.array([0]), day = 1, title="Titel", im_title = ["Original", "Threshold Value", "LDA without PN", "LDA with PA"], cmap = None, save_fig = None, show_fig = True):
